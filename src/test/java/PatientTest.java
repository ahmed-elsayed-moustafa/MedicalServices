...
public class PatientTest {
	...
	public void test6070Insurance() throws FileNotFoundException, IOException, ParseException {
		Patient p = new Between6570();
		p.setMedicalDiscount(new HasMedicalDiscount());
		p.addService(new Service("blood test", 1));
		p.addService(new Service("vaccine", 2));
	...
	public void testOver70Insurance() throws FileNotFoundException, IOException, ParseException {
		...
		/**
		 * 1)  Blood test= 78 * 1.05= 81.9
		 *     so cost is free. Over 100% discount
		 * 
		 * 1)  Vaccine= (27.50+30)57.5*0.90=51.75
		 * 2)  57.50-51.75.5=5.75
		 * 
		 *     0+5.75=42.5
		 */
	...
	public void testUnder5Insurance() throws FileNotFoundException, IOException, ParseException {
		...
		/**
		 * 1)  Blood test= 78 * 0.55= 42.9
		 * 2)  78-42.9=35.1
		 * 
		 * 1)  Vaccine= (27.50+30)57.5*0.40=23
		 * 2)  57.50-23=34.5
		 * 
		 *     34.5+34.1=69.6
		 */
